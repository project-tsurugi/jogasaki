...
write_full_context::write_full_context(class abstract::task_context* ctx, block_scope& variables,
    std::unique_ptr<kvs::storage> stg, kvs::transaction* tx, context_base::memory_resource* resource,
