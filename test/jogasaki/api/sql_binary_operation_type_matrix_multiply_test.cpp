...
TEST_F(sql_binary_operation_type_matrix_test, mul_int4_dec5) {
    test_binary_operation_with_type<kind::decimal>("c0*c1", "INT", "DECIMAL(5)", "(3,2)", 6, decimal_type(10, 0));  //TODO check
}
...
TEST_F(sql_binary_operation_type_matrix_test, mul_int8_dec5) {
    test_binary_operation_with_type<kind::decimal>("c0*c1", "BIGINT", "DECIMAL(5)", "(3,2)", 6, decimal_type(19, 0));  //TODO check
}
