...
status encode(
    ...
    return details::catch_domain_error([&]() {
        ...
        switch(type.kind()) {
            ...
            case kind::octet: return dest.write<runtime_t<kind::octet>>(src.get_value<runtime_t<kind::octet>>(offset), odr, vi.add_padding(), vi.length());
...
status encode(
    ...
    return details::catch_domain_error([&]() {
        ...
        switch(type.kind()) {
            ...
            case kind::octet: return dest.write<runtime_t<kind::octet>>(src.to<runtime_t<kind::octet>>(), odr, vi.add_padding(), vi.length());
...
status decode(
    ...
    return details::catch_domain_error([&]() {
        ...
        switch(type.kind()) {
            ...
            case kind::octet: dest = any{std::in_place_type<runtime_t<kind::octet>>, src.read<runtime_t<kind::octet>>(odr, false, (type.option<kind::octet>()->varying_ ? std::nullopt : type.option<kind::octet>()->length_), resource)}; break;
...
status decode(
    ...
    return details::catch_domain_error([&]() {
        ...
        switch(type.kind()) {
            ...
            case kind::octet: dest.set_value<runtime_t<kind::octet>>(offset, src.read<runtime_t<kind::octet>>(odr, false, (type.option<kind::octet>()->varying_ ? std::nullopt : type.option<kind::octet>()->length_), resource)); break;
...
status consume_stream(
    ...
    return details::catch_domain_error([&]() {
        ...
        switch(type.kind()) {
            ...
            case kind::octet: src.read<runtime_t<kind::octet>>(odr, true, (type.option<kind::octet>()->varying_ ? std::nullopt : type.option<kind::octet>()->length_), nullptr); break;
