...
enum class lob_reference_kind : std::int32_t {
    ...
    ///@brief lob data is provided by caller but not yet resolved as a valid reference
    provided,

    ///@brief lob data is generated by sql engine but not yet resolved as a valid reference
    generated,

    ///@brief lob reference is fetched from datastore and ready to use for reading
    fetched,

    ///@brief lob reference is resolved and ready to use for writing
    resolved,
};
...
[[nodiscard]] constexpr inline std::string_view to_string_view(lob_reference_kind value) noexcept {
    ...
    switch (value) {
        ...
        case kind::generated: return "generated"sv;
