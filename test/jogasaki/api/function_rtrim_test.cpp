...
class function_rtrim_test : public ::testing::Test, public api_test_base {
...
TEST_F(function_rtrim_test, basic1) {
    ...
    std::string query = std::string("SELECT rtrim(c0) FROM t ");
...
TEST_F(function_rtrim_test, basic2) {
    std::string input = std::string(" A😀あé  ");
    std::string res   = std::string(" A😀あé");
    execute_statement("create table t (c0 varchar(20))");
    std::string insert = "insert into t values ('" + input + "')";
...
TEST_F(function_rtrim_test, basic3) {
    std::string input = std::string(" A😀あé");
    std::string res   = std::string(" A😀あé");
...
TEST_F(function_rtrim_test, basic4) {
    std::string input = std::string("A😀あé  ");
    std::string res   = std::string("A😀あé");
    execute_statement("create table t (c0 char(20))");
    std::string insert = "insert into t values ('" + input + "')";
...
TEST_F(function_rtrim_test, empty) {
...
TEST_F(function_rtrim_test, null) {
...
TEST_F(function_rtrim_test, null2) {
    std::string input = std::string("null");
    execute_statement("create table t (c0 char(20))");
    std::string insert = "insert into t values ('" + input + "')";
    std::string query  = std::string("SELECT rtrim(c0) FROM t ");
