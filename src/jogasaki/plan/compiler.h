 ...
 */
[[nodiscard]] bool compile(std::string_view sql, compiler_context& ctx, parameter_set const* parameters = nullptr);
 ...
 */
[[nodiscard]] bool compile(compiler_context &ctx, parameter_set const* parameters = nullptr);
