 ...
 * @details helper class to override operator<< with record_ref and record_meta objects and print record content.
...
class record_printer {
    ...
    std::ostream& print_record(meta::record_meta const& meta) {
    ...
    friend std::ostream& operator<<(record_printer printer, meta::record_meta const& meta);
 ...
 * @return helper printer class, which must be used with operator<<(record_printer printer, meta::record_meta const& meta)
 * @attention until returned value is handed by the subsequent operator<<, nothing happens or written to the stream
 */
...
/**
 * @brief pass record metadata to printer and finish writing to stream
 * @param printer printer that is generated by the operator above (operator<<(std::ostream& os, record_ref rec))
 ...
 */
inline std::ostream& operator<<(record_printer printer, meta::record_meta const& meta) {
