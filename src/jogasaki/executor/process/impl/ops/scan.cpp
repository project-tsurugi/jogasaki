...
scan::scan(
    ...
    scan(
        ...
        index::create_fields(primary_idx, columns, info.vars_info_list()[block_index], true, true),
        index::create_fields(primary_idx, columns, info.vars_info_list()[block_index], false, true),
