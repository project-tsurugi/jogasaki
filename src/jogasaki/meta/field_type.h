...
public:
    ...
    using entity_type = std::variant<
        ...
        std::shared_ptr<octet_field_option>, // octet
        std::monostate, // bit
        std::monostate, // date
    ...
    [[nodiscard]] constexpr std::size_t runtime_type_size() const noexcept {
        ...
        switch (kind()) {
            ...
            case k::undefined: return field_type_traits<k::undefined>::size;
            default:
    ...
    [[nodiscard]] constexpr std::size_t runtime_type_alignment() const noexcept {
        ...
        switch (kind()) {
            ...
            case k::undefined: return field_type_traits<k::undefined>::alignment;
            default:
                // TODO implement cases for complex types
                std::abort();
        }
    ...
    friend std::ostream& operator<<(std::ostream& out, field_type const& value) {
        ...
        switch (k) {
            ...
            case kind::octet: return out << *value.option<kind::octet>();
...
inline bool operator==(field_type const& a, field_type const& b) noexcept {
    ...
    switch (a.kind()) {
        ...
        case kind::octet: return impl::eq<kind::octet>()(a, b);
