...
/**
 * @brief revoke statement for tables
 */
class revoke_table : public model::statement {
public:

    /**
     * @brief create empty object
     */
    revoke_table() = default;

    /**
     * @brief create new object
     */
    explicit revoke_table(
...
private:
    takatori::statement::revoke_table* rt_{};
};
