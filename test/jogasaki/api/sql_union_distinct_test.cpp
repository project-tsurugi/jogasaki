...
TEST_F(sql_union_distinct_test, union_all) {
    ...
    execute_statement("INSERT INTO t2 VALUES (2,20)");
    {
        ...
        execute_query("SELECT c0, c1 from t1 UNION DISTINCT SELECT c1, c0 from t2", result);
...
TEST_F(sql_union_distinct_test, union_distinct_with_same_table) {
    execute_statement("create table t (c0 int primary key, c1 int)");
    execute_statement("INSERT INTO t VALUES (1,10)");
    {
        std::vector<mock::basic_record> result{};
        execute_query("SELECT c0, c1 from t UNION DISTINCT SELECT c1, c0 from t", result);
        ASSERT_EQ(2, result.size());
        std::sort(result.begin(), result.end());
        EXPECT_EQ((create_nullable_record<kind::int4, kind::int4>(1, 10)), result[0]);
...
TEST_F(sql_union_distinct_test, union_all_same_table_3_times) {
    execute_statement("create table t (c0 int primary key, c1 int)");
    execute_statement("INSERT INTO t VALUES (1,10)");
    {
        std::vector<mock::basic_record> result{};
        execute_query("(SELECT c0, c0 from t UNION DISTINCT SELECT c0, c1 from t ) UNION DISTINCT SELECT c1, c1 from t", result);
...
TEST_F(sql_union_distinct_test, union_all_same_table_4_times_wide) {
    execute_statement("create table t (c0 int primary key, c1 int)");
    execute_statement("INSERT INTO t VALUES (1,10)");
    {
        std::vector<mock::basic_record> result{};
        execute_query("(SELECT c0, c0 from t UNION DISTINCT SELECT c0, c1 from t ) UNION DISTINCT (SELECT c1, c0 from t UNION DISTINCT SELECT c1, c1 from t)", result);
...
TEST_F(sql_union_distinct_test, union_all_same_table_4_times_deep) {
    execute_statement("create table t (c0 int primary key, c1 int)");
    execute_statement("INSERT INTO t VALUES (1,10)");
    {
        std::vector<mock::basic_record> result{};
...
TEST_F(sql_union_distinct_test, complex) {
    execute_statement("create table t (c0 int primary key, c1 int)");
    execute_statement("INSERT INTO t VALUES (1,10)");
    {
        std::vector<mock::basic_record> result{};
...
TEST_F(sql_union_distinct_test, different_types_int_bigint) {
