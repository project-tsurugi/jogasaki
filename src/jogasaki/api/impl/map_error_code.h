...
inline sql::error::Code map_error(jogasaki::error_code s) {
    switch (s) {
        ...
        case jogasaki::error_code::load_file_exception: return sql::error::LOAD_FILE_EXCEPTION;
        ...
        case jogasaki::error_code::dump_file_exception: return sql::error::DUMP_FILE_EXCEPTION;
        ...
        case jogasaki::error_code::sql_request_timeout_exception: return sql::error::SQL_REQUEST_TIMEOUT_EXCEPTION;
        ...
        // below are internal codes and should not be exposed
...
inline jogasaki::error_code map_error(sql::error::Code s) {
    switch (s) {
        ...
        case sql::error::LOAD_FILE_EXCEPTION: return jogasaki::error_code::load_file_exception;
        ...
        case sql::error::DUMP_FILE_EXCEPTION: return jogasaki::error_code::dump_file_exception;
        ...
        case sql::error::SQL_REQUEST_TIMEOUT_EXCEPTION: return jogasaki::error_code::sql_request_timeout_exception;
