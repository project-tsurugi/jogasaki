...
TEST_F(cast_to_string_test, from_float) {
    ...
    EXPECT_EQ(any_text("0.1"), details::from_float4::to_character(0.1f, ctx, std::nullopt, false));
    EXPECT_EQ(any_text("1.23457"), details::from_float4::to_character(1.234567f, ctx, std::nullopt, false));
...
TEST_F(cast_to_string_test, from_double) {
    ...
    EXPECT_EQ(any_text("0.1"), details::from_float8::to_character(0.1, ctx, std::nullopt, false));
    EXPECT_EQ(any_text("1.23457"), details::from_float8::to_character(1.234567, ctx, std::nullopt, false));
