...
public:
    ...
    std::shared_ptr<shuffle_info::aggregator_type> aggregator_ = std::make_shared<shuffle_info::aggregator_type>([this](accessor::record_ref target, accessor::record_ref source){
