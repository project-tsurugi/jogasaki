...
public:
     ...
     * @param partitions
     */
    shuffle_info(std::shared_ptr<meta::record_meta> record, std::vector<field_index_type> key_indices, std::shared_ptr<aggregator_type> aggregator = {}) :
     ...
     */
    [[nodiscard]] std::shared_ptr<aggregator_type> const& aggregator() const noexcept {
        return aggregator_;
    }
...
private:
    ...
    std::shared_ptr<aggregator_type> aggregator_{};
