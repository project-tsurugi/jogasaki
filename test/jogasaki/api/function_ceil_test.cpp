...
TEST_F(function_ceil_test, maxint) {
    execute_statement("create table t (c0 INT)");
...
TEST_F(function_ceil_test, minint) {
    execute_statement("create table t (c0 INT)");
...
TEST_F(function_ceil_test, bigint) {
...
TEST_F(function_ceil_test, maxbigint) {
    execute_statement("create table t (c0 BIGINT)");
...
TEST_F(function_ceil_test, null) {
    std::vector<mock::basic_record> result{};
    execute_statement("create table t (c0 INT)");
    execute_statement("insert into t values (8)");
    std::string query = std::string("SELECT ceil(null) FROM t");
    execute_query(query, result);
    ASSERT_EQ(1, result.size()) << "Query failed: " << query;
    EXPECT_TRUE(result[0].is_null(0)) << "Failed query: " << query;
}

TEST_F(function_ceil_test, decimal_38_38_min) {
...
TEST_F(function_ceil_test, decimal_38_38_max) {
    execute_statement("create table t (c0 DECIMAL(38, 38))");
    execute_statement("insert into t values (0.99999999999999999999999999999999999999)");
...
TEST_F(function_ceil_test, decimal_38_0_min) {
...
TEST_F(function_ceil_test, decimal_38_0_max) {
    execute_statement("create table t (c0 DECIMAL(38, 0))");
    execute_statement("insert into t values (99999999999999999999999999999999999999)");
...
TEST_F(function_ceil_test, decimal_1_1_min) {
    ...
    auto r1 = mock::typed_nullable_record<kind::decimal>(
        std::tuple{decimal_type()},
        runtime_t<meta::field_type_kind::decimal>(1, 0, 0, -1)
    );
    EXPECT_EQ(r1, result[0]) << "Failed query: " << query;
}
TEST_F(function_ceil_test, decimal_1_1_max) {
    execute_statement("create table t (c0 DECIMAL(1, 1))");
    execute_statement("insert into t values (0.9)");
    ...
    auto r1 = mock::typed_nullable_record<kind::decimal>(
        std::tuple{decimal_type()},
        runtime_t<meta::field_type_kind::decimal>(1, 0, 10, -1)
    );
    EXPECT_EQ(r1, result[0]) << "Failed query: " << query;
}
TEST_F(function_ceil_test, float_normal) {
    ...
    execute_query(query, result);
    ASSERT_EQ(1, result.size()) << "Query failed: " << query;
    EXPECT_EQ((create_nullable_record<kind::float4>(-3.0)), result[0])
        << "Failed query: " << query;
}

TEST_F(function_ceil_test, float_normal_plus) {
    execute_statement("create table t (c0 float)");
...
TEST_F(function_ceil_test, float_minus_zero) {
    execute_statement("create table t (c0 float)");
...
TEST_F(function_ceil_test, float_minus_nan) {
    execute_statement("create table t (c0 float)");
...
TEST_F(function_ceil_test, float_nan) {
    execute_statement("create table t (c0 float)");
    execute_statement("insert into t values ('NaN')");
...
TEST_F(function_ceil_test, float_infinity) {
    execute_statement("create table t (c0 float)");
...
TEST_F(function_ceil_test, float_minus_infinity) {
    execute_statement("create table t (c0 float)");
    execute_statement("insert into t values ('-Infinity')");
...
TEST_F(function_ceil_test, double_normal) {
    ...
    execute_query(query, result);
    ASSERT_EQ(1, result.size()) << "Query failed: " << query;
    EXPECT_EQ((create_nullable_record<kind::float8>(-3.0)), result[0])
        << "Failed query: " << query;
}
TEST_F(function_ceil_test, double_normal_plus) {
    execute_statement("create table t (c0 double)");
    execute_statement("insert into t values (3.14)");
...
TEST_F(function_ceil_test, double_minus_zero) {
    execute_statement("create table t (c0 double)");
    execute_statement("insert into t values (-0.0)");
...
TEST_F(function_ceil_test, double_minus_nan) {
    execute_statement("create table t (c0 double)");
    execute_statement("insert into t values ('-NaN')");
...
TEST_F(function_ceil_test, double_nan) {
    execute_statement("create table t (c0 double)");
    execute_statement("insert into t values ('NaN')");
...
TEST_F(function_ceil_test, double_infinity) {
    execute_statement("create table t (c0 double)");
    execute_statement("insert into t values ('Infinity')");
...
TEST_F(function_ceil_test, double_minus_infinity) {
    execute_statement("create table t (c0 double)");
    execute_statement("insert into t values ('-Infinity')");
