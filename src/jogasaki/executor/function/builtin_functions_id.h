...
enum function_id : std::size_t {
    id_11000 = yugawara::aggregate::declaration::minimum_builtin_function_id + minimum_aggregate_id,
    id_11001,
    id_11002,
    id_11003,
    id_11004,
...
static_assert(function_id::id_11000 == 11'000);
static_assert(function_id::id_11012 == 11'012);
