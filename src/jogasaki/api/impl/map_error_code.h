...
inline sql::error::Code map_error(jogasaki::error_code s) {
    switch (s) {
        ...
        case jogasaki::error_code::load_file_ioexception: return sql::error::LOAD_FILE_EXCEPTION;
        ...
        case jogasaki::error_code::dump_file_ioexception: return sql::error::DUMP_FILE_EXCEPTION;
        ...
        case jogasaki::error_code::sql_request_timed_out_exception: return sql::error::SQL_REQUEST_TIMEOUT_EXCEPTION;
...
inline jogasaki::error_code map_error(sql::error::Code s) {
    switch (s) {
        ...
        case sql::error::LOAD_FILE_EXCEPTION: return jogasaki::error_code::load_file_ioexception;
        ...
        case sql::error::DUMP_FILE_EXCEPTION: return jogasaki::error_code::dump_file_ioexception;
        ...
        case sql::error::SQL_REQUEST_TIMEOUT_EXCEPTION: return jogasaki::error_code::sql_request_timed_out_exception;
